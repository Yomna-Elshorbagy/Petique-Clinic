...
import { addCategory, deleteCategory, getAllCategories, softDeleteCategories, updateCategory } from '../../../Apis/CategoryApis'
...
const addmutation=useMutation({
  ...
  onSuccess:()=>{
     toast.success('Category added successfully', { position: 'top-center', autoClose: 1000 });
...
const updatemutation=useMutation({
  ...
  ,
  onSuccess:()=>{
    toast.success('Category updated successfully', { position: 'top-center', autoClose: 1000 });
    queryClient.invalidateQueries({ queryKey: ['categories'] });
      Setshowmodal(false);
      setUpdateId(null);
  },
...
const deletemutation=useMutation({
  ...
  onSuccess:()=>{
    toast.success('Category deleted  successfully', { position: 'top-center', autoClose: 1000 });
      queryClient.invalidateQueries({ queryKey: ['categories'] });
  },
  onError:(error)=>{
...
const softdeletemutation=useMutation({
  ...
  onSuccess:()=>{
    toast.success('Category archived successfully', { position: 'top-center', autoClose: 1000 });
      queryClient.invalidateQueries({ queryKey: ['categories'] });
  },
  onError(error) {
...
const categorycolumns:TableColumn <ICategory>[]=[
  ...
  },
  {
    ...
    cell:(row)=>(
     ...
     <img src={row.image?.secure_url  || "/placeholder-100x100.png"}
  ...
  },
{
  ...
  cell:(row)=>(
    <div className='flex items-center gap-3'>
     ...
     <button className='bg-yellow-50 text-yellow-600 p-2 rounded-full 
     ...
     <button className='bg-red-50 text-red-600 p-2 rounded-full
