        ...
        <div className="space-y-8 animate-fadeIn">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-sm border border-[#A98868]/10 flex items-center gap-4 hover:shadow-md transition-shadow">
                    ...
                    <div>
                        <p className="text-sm text-[#A98868] dark:text-gray-400 font-medium uppercase tracking-wider">
                            {t("userProfile.analytics.cards.totalSpending")}
                        </p>
                        <h3 className="text-2xl font-bold text-[#443935] dark:text-white">
                            {summary?.totalSpent.toLocaleString()} {t("userProfile.common.currency")}
                        </h3>
                    </div>
                </div>
                ...
                <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-sm border border-[#A98868]/10 flex items-center gap-4 hover:shadow-md transition-shadow">
                    ...
                    <div>
                        <p className="text-sm text-[#A98868] dark:text-gray-400 font-medium uppercase tracking-wider">
                            {t("userProfile.analytics.cards.totalOrders")}
                        </p>
                        <h3 className="text-2xl font-bold text-[#443935] dark:text-white">
                ...
                <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-sm border border-[#A98868]/10 flex items-center gap-4 hover:shadow-md transition-shadow">
                    ...
                    <div>
                        <p className="text-sm text-[#A98868] dark:text-gray-400 font-medium uppercase tracking-wider">
                            {t("userProfile.analytics.cards.avgOrderValue")}
                        </p>
                        <h3 className="text-2xl font-bold text-[#443935] dark:text-white">
                            {summary?.avgOrderValue.toLocaleString()} {t("userProfile.common.currency")}
                        </h3>
                    </div>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="bg-[#FCF9F4] dark:bg-gray-800/50 p-6 rounded-2xl border border-[#A98868]/10">
                    <div className="flex items-center gap-3 mb-6">
                        ...
                        <h4 className="text-lg font-bold text-[#443935] dark:text-white">
                            {t("userProfile.analytics.sections.topCategories")}
                        </h4>
                    </div>
                                ...
                                <div key={cat._id} className="space-y-1">
                                    <div className="flex justify-between text-sm">
                                        ...
                                        <span className="text-[#A98868]">
                                            {cat.totalQuantity} {t("userProfile.analytics.itemsBought")}
                                        </span>
                                    </div>
                ...
                <div className="bg-[#FCF9F4] dark:bg-gray-800/50 p-6 rounded-2xl border border-[#A98868]/10">
                    <div className="flex items-center gap-3 mb-6">
                        ...
                        <h4 className="text-lg font-bold text-[#443935] dark:text-white">
                            {t("userProfile.analytics.sections.favoriteProducts")}
                        </h4>
                    </div>
                    <div className="space-y-4">
                                ...
                                >
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        <p className="text-xs text-[#A98868]">
                                            {prod.totalQuantity} {t("userProfile.analytics.timesPurchased")}
                                        </p>
                                    </div>
                                    <div className="text-right">
                                        <p className="text-sm font-bold text-[#F2A056]">
                                            {prod.totalSpent.toLocaleString()} {t("userProfile.common.currency")}
                                        </p>
                                    </div>
                                </div>
                            ))
